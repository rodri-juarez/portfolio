...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  changeLanguage("en");
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "My Work | Rodrigo Juarez", "description": "Lets get in touch!" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="stack gap-20"> <main class="wrapper stack about gap-20"${addAttribute(renderTransition($$result2, "q5dz4tbn"), "data-astro-transition-scope")}> ${renderComponent($$result2, "Hero", $$Hero, { "title": "Lets get in touch!", "tagline": "Drop me a line and I will get back to you as soon as possible.", "align": "center" })} <section class="flex flex-col gap-10 lg:flex-row"> <div class="flex flex-col w-[50%] h-auto gap-10"> <div class="flex flex-col gap-2"> <label for="mail">Email</label> <p id="mail" class="text-2xl">juarezr100@gmail.com</p> </div> ${renderComponent($$result2, "CallToAction", $$CallToAction, { "href": "https://drive.google.com/uc?id=1QcJeyPQMJxSIhpLuMb8zBlrVu1-KkPpm&export=download", "extraStyles": "w-[20rem] h-[4rem] items-center" }, { "default": ($$result3) => renderTemplate`${t("CONTACT.DOWNLOAD")}${renderComponent($$result3, "Icon", $$Icon, { "icon": "download", "size": "1.2em" })} ` })} </div> ${renderComponent($$result2, "ContactUs", null, { "submit": t("FORM.SUBMIT"), "name": t("FORM.NAME.LABEL"), "message": t("FORM.MESSAGE.LABEL"), "namePlaceholder": t("FORM.NAME.PLACEHOLDER"), "messagePlaceholder": t("FORM.MESSAGE.PLACEHOLDER"), "emailPlaceholder": t("FORM.EMAIL.PLACEHOLDER"), "client:only": true, "client:component-hydration": "only", "client:component-path": "/home/rodrigo/Escritorio/Proyects/new-brand/src/components/ContactUS", "client:component-export": "ContactUs" })} </section> </main> </div> ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
}, "/home/rodrigo/Escritorio/Proyects/new-brand/src/pages/contact.astro", "self");

const $$file = "/home/rodrigo/Escritorio/Proyects/new-brand/src/pages/contact.astro";
const $$url = "/contact";
